...
class Album extends Model
{
     ...
     */
    private function convertToWebP($file, $directory = 'albums')
    {
        try {
            ...
            if ($width > $maxDimension || $height > $maxDimension) {
                ...
                Log::info('Resized large album cover image', [
            ...
            if ($success) {
                Log::info('Album cover image successfully converted to WebP', [
                    'original_extension' => $originalExtension,
            ...
            Log::error('Error converting album cover image to WebP', [
    ...
    public function setImageAttribute($value)
    {
        try {
            if ($value instanceof UploadedFile) {
                // Convert to WebP and store under storage/app/public/albums
            ...
            Log::error('Error in setImageAttribute for Album', [
                'exception' => get_class($e),
                'message' => $e->getMessage(),
            ]);
            $this->attributes['image'] = null;
