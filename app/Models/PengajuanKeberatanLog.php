...
class PengajuanKeberatanLog extends Model
{
    protected $fillable = [
        'pengajuan_keberatan_id',
        'action',
        'old_status',
        'new_status',
        'notes',
    ...
    /**
     * Get the pengajuan keberatan that owns the log.
     */
    public function pengajuanKeberatan()
    {
        return $this->belongsTo(PengajuanKeberatan::class);
    }
