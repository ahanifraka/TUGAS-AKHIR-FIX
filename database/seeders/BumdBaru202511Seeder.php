...
class BumdBaru202511Seeder extends Seeder
{
    /**
    ...
    {
        $csvPath = database_path('seeders/bumd/bumd_202511141420.csv');
        if (!is_file($csvPath)) {
        ...
        fclose($handle);
        $this->command?->info("BumdBaru202511Seeder completed. Inserted/updated {$count} records.");
    }
}
