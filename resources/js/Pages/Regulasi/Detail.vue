<template>
    ...
    <GuestLayout>
        <Hero :breadcrumb="breadcrumbItems" :title="props.item.judul_peraturan || props.item.title" />
...
const breadcrumbItems = [
    ...
    { label: props.item.judul_peraturan || props.item.title, url: null },
];
...
function goBack() {
    router.visit(route('regulasi.indexPublic'))
}
